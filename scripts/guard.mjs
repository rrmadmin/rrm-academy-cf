...
function checkRequiredFiles() {
  ...
  const DIR_MINIMUMS = [
    ...
    { dir: 'functions/api/billing', min: 13, note: 'billing endpoints (post-2026-05-15 decomposition: 8 + _shared + _migration-handoff + _webhook-refund + _donor-gift + _supporter-gift)' },
  ];
