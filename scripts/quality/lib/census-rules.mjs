...
export const CATEGORIES = {
  ...
  'GENERATED': 'Machine-generated files (src/generated/*, src/data/*.json build artifacts). None are currently inside the enumerated surface because they are gitignored or non-JS, but the category is kept so a generated .js/.ts landing in the surface must be classified here explicitly rather than gated by accident.',
