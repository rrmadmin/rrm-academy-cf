...
| Detail | `src/pages/library/[...slug].astro` | `data-pagefind-body`, JSON-LD typed from the record (MedicalScholarlyArticle / Book / Chapter / Report / ScholarlyArticle / CreativeWork) |
