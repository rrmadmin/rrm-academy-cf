...
| Patient and provider pillars: full byline string at top of page; in-body references use "Dr. Whittaker" only (never "Dr. Naomi" or "Dr. Naomi Whittaker" in body copy) | HARD RULE | `feedback-naomi-honorific-to-members.md` |
...
| D9 | Patient and provider pillars carry full Naomi byline at top of page; in-body references use "Dr. Whittaker" | Clinical authority context; honorific rule applies |
