...
| `/rrm-care-team` | `src/pages/rrm-care-team/index.astro` (companion page to gated-PDF-download guide by Rebecca Vavilov, PhD; standalone, does not use GuideLayout) |
